...
`)},k={root:"p-floatlabel"},D=y.extend({name:"floatlabel",theme:T,classes:k}),F={name:"BaseFloatLabel",extends:O,props:{},style:D,provide:function(){return{$pcFloatLabel:this,$parentInstance:this}}},M={name:"FloatLabel",extends:F,inheritAttrs:!1};function R(t,e,n,r,a,l){return g(),A("span",E({class:t.cx("root")},t.ptmi("root")),[S(t.$slots,"default")],16)}M.render=R;export{N as A,M as s};
