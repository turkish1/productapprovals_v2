import{E as s,ac as v,P as d,b as m,c as p,F as h,m as u,D as l,e as a,Q as c,z as f}from"./index-0bIYIHjx.js";var g=function(i){var e=i.dt;return`
.p-timeline {
    display: flex;
    flex-grow: 1;
...
`)},k={root:function(i){var e=i.props;return["p-timeline p-component","p-timeline-"+e.align,"p-timeline-"+e.layout]},event:"p-timeline-event",eventOpposite:"p-timeline-event-opposite",eventSeparator:"p-timeline-event-separator",eventMarker:"p-timeline-event-marker",eventConnector:"p-timeline-event-connector",eventContent:"p-timeline-event-content"},b=s.extend({name:"timeline",theme:g,classes:k}),x={name:"BaseTimeline",extends:d,props:{value:null,align:{mode:String,default:"left"},layout:{mode:String,default:"vertical"},dataKey:null},style:b,provide:function(){return{$pcTimeline:this,$parentInstance:this}}},y={name:"Timeline",extends:x,inheritAttrs:!1,methods:{getKey:function(i,e){return this.dataKey?v(i,this.dataKey):e},getPTOptions:function(i,e){return this.ptm(i,{context:{index:e,count:this.value.length}})}}};function z(n,i,e,w,T,r){return m(),p("div",l({class:n.cx("root")},n.ptmi("root")),[(m(!0),p(h,null,u(n.value,function(o,t){return m(),p("div",l({key:r.getKey(o,t),class:n.cx("event"),ref_for:!0},r.getPTOptions("event",t)),[a("div",l({class:n.cx("eventOpposite",{index:t}),ref_for:!0},r.getPTOptions("eventOpposite",t)),[c(n.$slots,"opposite",{item:o,index:t})],16),a("div",l({class:n.cx("eventSeparator"),ref_for:!0},r.getPTOptions("eventSeparator",t)),[c(n.$slots,"marker",{item:o,index:t},function(){return[a("div",l({class:n.cx("eventMarker"),ref_for:!0},r.getPTOptions("eventMarker",t)),null,16)]}),t!==n.value.length-1?c(n.$slots,"connector",{key:0,item:o,index:t},function(){return[a("div",l({class:n.cx("eventConnector"),ref_for:!0},r.getPTOptions("eventConnector",t)),null,16)]}):f("",!0)],16),a("div",l({class:n.cx("eventContent"),ref_for:!0},r.getPTOptions("eventContent",t)),[c(n.$slots,"content",{item:o,index:t})],16)],16)}),128))],16)}y.render=z;export{y as s};
