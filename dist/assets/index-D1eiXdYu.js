...
`)},x={root:function(n){var t=n.instance;return["p-progressbar p-component",{"p-progressbar-determinate":t.determinate,"p-progressbar-indeterminate":t.indeterminate}]},value:"p-progressbar-value",label:"p-progressbar-label"},_=A.extend({name:"progressbar",theme:$,classes:x}),ee={name:"BaseProgressBar",extends:z,props:{value:{type:Number,default:null},mode:{type:String,default:"determinate"},showValue:{type:Boolean,default:!0}},style:_,provide:function(){return{$pcProgressBar:this,$parentInstance:this}}},R={name:"ProgressBar",extends:ee,inheritAttrs:!1,computed:{progressStyle:function(){return{width:this.value+"%",display:"flex"}},indeterminate:function(){return this.mode==="indeterminate"},determinate:function(){return this.mode==="determinate"}}},ne=["aria-valuenow"];function te(e,n,t,a,i,l){return r(),c("div",s({role:"progressbar",class:e.cx("root"),"aria-valuemin":"0","aria-valuenow":e.value,"aria-valuemax":"100"},e.ptmi("root")),[l.determinate?(r(),c("div",s({key:0,class:e.cx("value"),style:l.progressStyle},e.ptm("value")),[e.value!=null&&e.value!==0&&e.showValue?(r(),c("div",s({key:0,class:e.cx("label")},e.ptm("label")),[g(e.$slots,"default",{},function(){return[k(w(e.value+"%"),1)]})],16)):m("",!0)],16)):l.indeterminate?(r(),c("div",s({key:1,class:e.cx("value")},e.ptm("value")),null,16)):m("",!0)],16,ne)}R.render=te;var le=function(n){var t=n.dt;return`
