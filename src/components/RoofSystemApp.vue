...
<template>
    <div id="id" class="grid grid-cols-3 gap-6">
        <div
            class="roof-app"
            style="margin-left: 200px; margin-top: 50px; border: none; border-radius: 12px; box-shadow: 4px 4px 16px rgb(22, 183, 183); padding-bottom: 10px; border: none; position: center; max-height: 400px; width: 500px; top: 8vh"
        >
