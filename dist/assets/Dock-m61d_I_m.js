import{T as M}from"./index-Dro9QS85.js";import{u as B,r as S,b as A,c as s,d as l,e as f,i as m,F as D,m as C,O as k,g,f as u,R as K,t as N,n as U,S as P,B as j,M as T,U as L,V as q,W as b,X as x,A as d,Y as O,P as _,_ as z,$ as H}from"./index-CVviCf6s.js";import{s as R,a as V,b as W}from"./index-DJotzXza.js";const X={class:"card"},Y=["href","onClick"],G={__name:"UserDash",setup(e){B();const t=S([{route:"/dock",label:"Dashboard",icon:"pi pi-home"},{route:"/projects",label:"Projects",icon:"pi pi-chart-line"},{route:"/dashboard",label:"Start a Permit",icon:"pi pi-list"},{route:"/status",label:"status",icon:"pi pi-inbox"}]);return(n,o)=>{const c=A("router-link"),i=R,p=V,y=W,a=P;return s(),l("div",X,[f(y,{value:"/dashboard"},{default:m(()=>[f(p,null,{default:m(()=>[(s(!0),l(D,null,C(t.value,r=>(s(),k(i,{key:r.label,value:r.route},{default:m(()=>[r.route?(s(),k(c,{key:0,to:r.route,custom:""},{default:m(({href:v,navigate:h})=>[g((s(),l("a",{href:v,onClick:h,class:"flex items-center gap-2 text-inherit"},[u("i",{class:K(r.icon)},null,2),u("span",null,N(r.label),1)],8,Y)),[[a]])]),_:2},1032,["to"])):U("",!0)]),_:2},1032,["value"]))),128))]),_:1})]),_:1})])}}};var J=function(t){var n=t.dt;return`
.p-dock {
    position: absolute;
    z-index: 1;
    display: flex;
