...
`)},ne={root:function(t){var n=t.instance;return["p-progressbar p-component",{"p-progressbar-determinate":n.determinate,"p-progressbar-indeterminate":n.indeterminate}]},value:"p-progressbar-value",label:"p-progressbar-label"},le=P.extend({name:"progressbar",theme:te,classes:ne}),ie={name:"BaseProgressBar",extends:D,props:{value:{type:Number,default:null},mode:{type:String,default:"determinate"},showValue:{type:Boolean,default:!0}},style:le,provide:function(){return{$pcProgressBar:this,$parentInstance:this}}},W={name:"ProgressBar",extends:ie,inheritAttrs:!1,computed:{progressStyle:function(){return{width:this.value+"%",display:"flex"}},indeterminate:function(){return this.mode==="indeterminate"},determinate:function(){return this.mode==="determinate"}}},ae=["aria-valuenow"];function se(e,t,n,a,i,l){return s(),f("div",o({role:"progressbar",class:e.cx("root"),"aria-valuemin":"0","aria-valuenow":e.value,"aria-valuemax":"100"},e.ptmi("root")),[l.determinate?(s(),f("div",o({key:0,class:e.cx("value"),style:l.progressStyle},e.ptm("value")),[e.value!=null&&e.value!==0&&e.showValue?(s(),f("div",o({key:0,class:e.cx("label")},e.ptm("label")),[v(e.$slots,"default",{},function(){return[k(S(e.value+"%"),1)]})],16)):g("",!0)],16)):l.indeterminate?(s(),f("div",o({key:1,class:e.cx("value")},e.ptm("value")),null,16)):g("",!0)],16,ae)}W.render=se;var oe=function(t){var n=t.dt;return`
