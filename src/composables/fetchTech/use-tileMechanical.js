...
export default function useMech() {
    ...
    //         // if your lambda returns an array of NOA rows, use the first
    //         const r = arr[0];

    //         const mechanical = {
    //             noa: r.NOA,
    //             manufacturer: typeof r.applicant === 'string' ? r.applicant.trim() : r.applicant,
    //             material: r.material,
    //             selection: r.AdhesiveMaterials ?? r.AdhesiveMaterial,
    //             description: r.description,
    //             select_tile: r.Select_Tile,
    //             tile_map: r.Tile_Map,
    //             table2_map: r.Table2_Map,
    //             Table2: r.Table2,
    //             Table3: r.Table3,
    //             resistance: r.Resistance,
    //             expiration_date: r.expiration_date,
    //             two_ten_d_RS_Nails: r.two_ten_d_RS_Nails,
    //             one_number_eight_screw: r.one_number_eight_screw,
    //             two_number_eight_screw: r.two_number_eight_screw,
    //             mechanicaltilefastener: r.mechanicaltilefastener,
    //             fastenerValues: r.fastenerValues
    //         };

    //         // update reactive mirror (if you use it elsewhere)
    //         Object.assign(mechanicalData, mechanical);

    //         // persist to store once
    //         mechStore.addNoa(mechanical);
