...
export function useLayout() {
    ...
    return { layoutConfig: layoutConfig, layoutState, onMenuToggle, isSidebarActive, isDarkTheme, getPrimary, getSurface, setActiveMenuItem, toggleDarkMode, setPrimary, setSurface, setPreset, resetMenu, setMenuMode };
}
